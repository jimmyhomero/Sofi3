...
FOR %%x IN ("\Users\neora\Desktop\FacturaScripts\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=\Users\neora\Desktop\FacturaScripts\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=\Users\neora\Desktop\FacturaScripts\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=\Users\neora\Desktop\FacturaScripts\php\php.exe"
GOTO :INSTALLED
