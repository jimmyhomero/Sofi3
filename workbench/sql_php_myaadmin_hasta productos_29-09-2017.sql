...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-09-2017 a las 03:59:58
...
(1, 'IVA', '10', NULL, NULL, NULL, NULL, NULL),
(2, 'UTILIDAD', '10', NULL, NULL, NULL, NULL, NULL),
...
CREATE TABLE `equipos` (
  ...
  `nombreSof` varchar(80) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(20, '2017-09-27', '2017-09-27 17:33:14', '10.0', '116.36', '', '128.00', '28.0', 'FACTURA', '', 2, 2, 'PC', '005-001-00000200', 1),
(21, '2017-09-27', '2017-09-27 19:22:27', '10.0', '232.73', '', '256.00', '56.0', 'FACTURA', '', 2, 2, 'PC', '005-001-00000200', 1),
(22, '2017-09-27', '2017-09-28 01:37:26', '10.0', '465.45', '', '512.00', '112.0', 'FACTURA', '', 1, 2, 'PC', '005-001-00000200', 1),
(23, '2017-09-27', '2017-09-28 01:38:23', '10.0', '116.36', '', '128.00', '28.0', 'FACTURA', '', 2, 2, 'PC', '005-001-00000200', 1),
(24, '2017-09-27', '2017-09-28 01:43:17', '10.0', '116.36', '', '128.00', '28.0', 'FACTURA', '', 2, 2, 'PC', '005-001-00000200', 1),
(25, '2017-09-27', '2017-09-28 01:51:48', '10.0', '23.27', '', '25.60', '5.600000000000001', 'FACTURA', '', 2, 2, 'PC', '005-001-00000200', 1);
...
(1, 'ALMOADAS KL', '', '', '10', '28', '12.80', '48', 'UNIDADES', ' ,  ,  ,  ,  ,  , ', '', '', '', '-- AÑO -- -- MESES -- -- SEMANAS -- -- AÑO -- -- MESES -- -- SEMANAS -- -- AÑO -- -- MESES -- -- SEMANAS -- ', 4, 2),
(2, 'DISCO DURO HGS', '', '', '100', '28', '128.00', '80', 'UNIDADES', ' ,  ,  ,  , ', '', '', '', '-- AÑO -- -- MESES -- -- SEMANAS -- -- AÑO -- -- MESES -- -- SEMANAS -- ', 4, 2);
...
--
ALTER TABLE `facturas`
  MODIFY `Codigo` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
