...
public class NotaCredito {
	...
	public void generatePDF(ec.unomas.notacredito.NotaCredito notaCredito, ServletOutputStream servletOutputStream) throws DocumentException, MalformedURLException, IOException{
		...
		if (notaCredito.getContribuyenteEspecial()>0){
        ...
        */
        ...
        // DETALLES LOOP
        Vector<ec.unomas.notacredito.Detalles> detalles = notaCredito.getDetalles();
        ...
        Vector<ec.unomas.notacredito.InfoAdicional> infoAdicional = notaCredito.getInfoAdicional();
