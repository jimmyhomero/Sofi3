...
public class NotaDebito {
	...
	public void generatePDF(ec.unomas.notadebito.NotaDebito notaDebito, ServletOutputStream servletOutputStream) throws DocumentException, MalformedURLException, IOException{
		...
		if (notaDebito.getContribuyenteEspecial()>0){
        ...
        // DETALLES LOOP
        Vector<ec.unomas.notadebito.Motivos> motivos = notaDebito.getMotivos();
        ...
        Vector<ec.unomas.notadebito.InfoAdicional> infoAdicional = notaDebito.getInfoAdicional();
