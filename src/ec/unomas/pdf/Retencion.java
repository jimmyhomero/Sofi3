...
public class Retencion {
	...
	public void generatePDF(ec.unomas.retencion.Retencion retencion, ServletOutputStream servletOutputStream) throws DocumentException, MalformedURLException, IOException{
		...
		if (retencion.getContribuyenteEspecial()>0){
