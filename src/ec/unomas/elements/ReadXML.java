...
import ec.unomas.factura.*;
import ec.unomas.guiaremision.*;
import ec.unomas.notacredito.*;
import ec.unomas.notadebito.*;
import ec.unomas.retencion.*;
...
public class ReadXML {
	...
	public Factura readFactura(Document doc) throws TagNotFoundException, ParserConfigurationException, SAXException, IOException{
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta ambiente");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta tipoEmision");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta razonSocial");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta nombreComercial");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta ruc");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta claveAcceso");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta codDoc");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta estab");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta ptoEmi");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta secuencial");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta dirMatriz");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta fechaEmision");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta dirEstablecimiento");
	    }
		...
		try{
		    ...
		    factura.setContribuyenteEspecial(Integer.parseInt(((Node) contribuyenteEspecial.item(0)).getNodeValue()));
		}catch (Exception e){
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta obligadoContabilidad");
	    }
	    ...
	    try{
	    	...
	    	//throw new TagNotFoundException("Falta comercio exterior");
	    }
	    ...
	    try{
	    	...
	    	//throw new TagNotFoundException("Falta incoTermFactura");
	    }
	    ...
	    try{
	    	...
	    	//throw new TagNotFoundException("Falta lugarIncoTerm");
	    }
	    ...
	    try{
	    	...
	    	//throw new TagNotFoundException("Falta paisOrigen");
	    }
	    ...
	    try{
	    	...
	    	//throw new TagNotFoundException("Falta puertoEmbarque");
	    }
	    ...
	    try{
	    	...
	    	//throw new TagNotFoundException("Falta puertoDestino");
	    }
	    ...
	    try{
	    	...
	    	//throw new TagNotFoundException("Falta paisDestino");
	    }
	    ...
	    try{
	    	...
	    	//throw new TagNotFoundException("Falta paisAdquisicion");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta tipoIdentificacionComprador");
	    }
	    try{
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta razonSocialComprador");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta identificacionComprador");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta totalSinImpuestos");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta el total de descuento");
	    }
		...
		for (int ti = 0; ti < totalImpuestoTags.getLength(); ti++) {
			...
			if (impuesto.getNodeType() == Node.ELEMENT_NODE) {
				...
				try{
			    	...
			    	throw new TagNotFoundException("Falta el codigo (total impuestos)");
			    }
				...
				try{
			    	...
			    	throw new TagNotFoundException("Falta el codigo de porcentaje (total impuestos)");
			    }
				...
				try{
			    	...
			    	throw new TagNotFoundException("Falta la base imponible");
			    }
				...
				try{
			    	...
			    	throw new TagNotFoundException("Falta el valor");
			    }
			}
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta la propina");
	    }
		...
		try{
	    	...
	    	//throw new TagNotFoundException("Falta fleteInternacional");
	    }
		...
		try{
	    	...
	    	//throw new TagNotFoundException("Falta seguroInternacional");
	    }
		...
		try{
	    	...
	    	//throw new TagNotFoundException("Falta gastosAduaneros");
	    }
		...
		try{
	    	...
	    	//throw new TagNotFoundException("Falta gastosTransporteOtros");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta el importe total");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta la moneda");
	    }
			...
			for (int ti = 0; ti < pagoTags.getLength(); ti++) {
				...
				if (pagoNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					try{
				    	...
				    	throw new TagNotFoundException("Falta la forma de pago");
				    }
					...
					try{
				    	...
				    	throw new TagNotFoundException("Falta el total");
				    }
					...
					try{
				    	...
				    	//throw new TagNotFoundException("Falta el plazo");
				    }
					...
					try{
				    	...
				    	throw new TagNotFoundException("Falta la unidad de tiempo");
				    }
				}
				pagos.add(pago);
			}
		...
		for (int d = 0; d < detalleTags.getLength(); d++) {
			...
			if (detalle.getNodeType() == Node.ELEMENT_NODE) {
				...
				try{
			    	...
			    	throw new TagNotFoundException("Falta el codigo principal");
			    }
			    ...
			    try{
			    	...
			    	throw new TagNotFoundException("Falta la descripcion");
			    }
			    ...
			    try{
			    	...
			    	throw new TagNotFoundException("Falta la cantidad");
			    }
			    ...
			    try{
			    	...
			    	throw new TagNotFoundException("Falta el precio unitario");
			    }
			    ...
			    try{
			    	...
			    	throw new TagNotFoundException("Falta el descuento");
			    }
			    ...
			    try{
			    	...
			    	throw new TagNotFoundException("Falta el precio total sin impuestos");
			    }
			    ...
			    try{
					...
					Vector<ec.unomas.factura.DetAdicional> detAdicionales = new Vector<ec.unomas.factura.DetAdicional>();
					for (int da=0; da<detAdicionalTag.getLength(); ++da) {
						ec.unomas.factura.DetAdicional factura_detAdicional = new ec.unomas.factura.DetAdicional();
				...
				Vector<ec.unomas.factura.Impuesto> DetImpuestos = new Vector<ec.unomas.factura.Impuesto>();
				for (int di = 0; di < detImpuestosTag.getLength(); di++) {
					ec.unomas.factura.Impuesto impuesto = new ec.unomas.factura.Impuesto();
					...
					if (detImpuestos.getNodeType() == Node.ELEMENT_NODE) {
						...
						try{
					    	...
					    	throw new TagNotFoundException("Falta el codigo (impuesto)");
					    }
						...
						try{
					    	...
					    	throw new TagNotFoundException("Falta el codigo de porcentaje (impuesto)");
					    }
						...
						try{
					    	...
					    	throw new TagNotFoundException("Falta la tarifa");
					    }
		...
		try{
			...
			for (int ca=0; ca<campoAdicionalTags.getLength(); ++ca) {
				ec.unomas.factura.InfoAdicional factura_infoAdicional = new ec.unomas.factura.InfoAdicional();
	...
	public Retencion readRetencion(Document doc) throws TagNotFoundException{
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta el ambiente");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta el tipo de emision");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta la razon social");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta el RUC");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta la clave de acceso");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta el codigo de documento");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta el establecimiento");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta el punto de emision");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta el secuencial");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta el direccion matriz");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta la fecha de emision");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta la direccion del establecimiento");
	    }
	    ...
	    try{
		    ...
		    Element contribuyenteEspecialElement = (Element) contribuyenteEspecialTag.item(0);
		    NodeList contribuyenteEspecial = contribuyenteEspecialElement.getChildNodes();
		    retencion.setContribuyenteEspecial(Integer.parseInt(((Node) contribuyenteEspecial.item(0)).getNodeValue()));
	    }catch (NullPointerException e){
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta obligado a llevar contabilidad");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta el tipo de identificacion del sujeto retenido");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta la razon social del sujeto retenido");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta la identificacion del sujeto retenido");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta el periodo fiscal");
	    }
		...
		for (int d = 0; d < impuestoTags.getLength(); d++) {
			ec.unomas.retencion.Impuesto retencion_impuestos = new ec.unomas.retencion.Impuesto();
			...
			if (impuesto.getNodeType() == Node.ELEMENT_NODE) {
				...
				try{
			    	...
			    	throw new TagNotFoundException("Falta el codigo de retencion");
			    }
				...
				try{
			    	...
			    	throw new TagNotFoundException("Falta el porcentaje a retener");
			    }
				...
				try{
			    	...
			    	throw new TagNotFoundException("Falta el valor retenido");
			    }
				...
				try{
			    	...
			    	throw new TagNotFoundException("Falta el codigo de documento de sustento");
			    }
				...
				try{
			    	...
			    	throw new TagNotFoundException("Falta el numero de documento de sustento");
			    }
				...
				try{
			    	...
			    	throw new TagNotFoundException("Falta la fecha de emision del documento de sustento");
			    }
			}
		...
		try{
			...
			NodeList campoAdicionalTags = infoAdicionalElements.getElementsByTagName("campoAdicional");
			for (int ca=0; ca<campoAdicionalTags.getLength(); ++ca) {
				ec.unomas.retencion.InfoAdicional retencion_infoAdicional = new ec.unomas.retencion.InfoAdicional();
				Node campoAdicional = campoAdicionalTags.item(ca);
				NamedNodeMap campoAdicionalAttr = campoAdicional.getAttributes();
	...
	public NotaDebito readNotaDebito(Document doc) throws NullPointerException{
	    ...
	    try{
		    ...
		    Element contribuyenteEspecialElement = (Element) contribuyenteEspecialTag.item(0);
		    NodeList contribuyenteEspecial = contribuyenteEspecialElement.getChildNodes();
		    notaDebito.setContribuyenteEspecial(Integer.parseInt(((Node) contribuyenteEspecial.item(0)).getNodeValue()));
	    }catch (NullPointerException e){
	    }
		...
		for (int ti = 0; ti < impuestoTags.getLength(); ti++) {
			ec.unomas.notadebito.Impuestos impuesto = new ec.unomas.notadebito.Impuestos(); 
		...
		for (int d = 0; d < motivosTags.getLength(); d++) {
			ec.unomas.notadebito.Motivos notadebito_motivos = new ec.unomas.notadebito.Motivos();
		...
		try{
			...
			NodeList campoAdicionalTags = infoAdicionalElements.getElementsByTagName("campoAdicional");
			for (int ca=0; ca<campoAdicionalTags.getLength(); ++ca) {
				ec.unomas.notadebito.InfoAdicional notadebito_infoAdicional = new ec.unomas.notadebito.InfoAdicional();
				Node campoAdicional = campoAdicionalTags.item(ca);
				NamedNodeMap campoAdicionalAttr = campoAdicional.getAttributes();
	...
	public NotaCredito readNotaCredito(Document doc) throws TagNotFoundException{
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta la direccion matriz");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta la direccion de establecimiento");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta el tipo de identificacion del comprador");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta la razon social del comprador");
	    }
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta la identificacion del comprador");
	    }
	    ...
	    try{
		    ...
		    Element contribuyenteEspecialElement = (Element) contribuyenteEspecialTag.item(0);
		    NodeList contribuyenteEspecial = contribuyenteEspecialElement.getChildNodes();
		    notaCredito.setContribuyenteEspecial(Integer.parseInt(((Node) contribuyenteEspecial.item(0)).getNodeValue()));
	    }catch (NullPointerException e){
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta el codigo de documento modificado");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta el numero de documento modificado");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta la fecha de emision de documento de sustento");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta total sin impuestos");
	    }
	    ...
	    try{
	    	...
	    	throw new TagNotFoundException("Falta el valor de modificacion");
	    }
		...
		NodeList totalImpuestoTags = totalConImpuestosElements.getElementsByTagName("totalImpuesto");
		for (int ti = 0; ti < totalImpuestoTags.getLength(); ti++) {
			ec.unomas.notacredito.TotalConImpuestos totalImpuesto = new ec.unomas.notacredito.TotalConImpuestos(); 
			Node impuesto = totalImpuestoTags.item(ti);
			if (impuesto.getNodeType() == Node.ELEMENT_NODE) {
				Element impuestoElement = (Element) impuesto;
				...
				try{
			    	...
			    	throw new TagNotFoundException("Falta el codigo (total impuesto)");
			    }
				...
				try{
			    	...
			    	throw new TagNotFoundException("Falta el codigo de porcentaje (total impuesto)");
			    }
				...
				try{
			    	...
			    	throw new TagNotFoundException("Falta el valor (total impuesto)");
			    }
			}
		...
		try{
	    	...
	    	throw new TagNotFoundException("Falta el motivo");
	    }
		...
		NodeList detalleTags = detallesElements.getElementsByTagName("detalle");
		for (int d = 0; d < detalleTags.getLength(); d++) {
			ec.unomas.notacredito.Detalles notacredito_detalle = new ec.unomas.notacredito.Detalles();
			Node detalle = detalleTags.item(d);
			if (detalle.getNodeType() == Node.ELEMENT_NODE) {
				Element detalleElement = (Element) detalle;
				...
				try{
					...
					try{
				    	...
				    	throw new TagNotFoundException("Falta el codigo interno");
				    }
				}
			    try{
			    ...
			    try{
					...
					NodeList detAdicionalTag = detallesAdicionalesElements.getElementsByTagName("detAdicional");
					Vector<ec.unomas.notacredito.DetAdicional> detAdicionales = new Vector<ec.unomas.notacredito.DetAdicional>();
					for (int da=0; da<detAdicionalTag.getLength(); ++da) {
						ec.unomas.notacredito.DetAdicional notacredito_detAdicional = new ec.unomas.notacredito.DetAdicional();
						Node detAdicional = detAdicionalTag.item(da);
						NamedNodeMap detAdicionalAttr = detAdicional.getAttributes();
				...
				NodeList detImpuestosTag = impuestosElements.getElementsByTagName("impuesto");
				Vector<ec.unomas.notacredito.DetImpuestos> DetImpuestos = new Vector<ec.unomas.notacredito.DetImpuestos>();
				for (int di = 0; di < detImpuestosTag.getLength(); di++) {
					ec.unomas.notacredito.DetImpuestos impuesto = new ec.unomas.notacredito.DetImpuestos();
					Node detImpuestos = detImpuestosTag.item(di);
					if (detImpuestos.getNodeType() == Node.ELEMENT_NODE) {
						Element detImpuestosElement = (Element) detImpuestos;
						...
						try{
					    	...
					    	throw new TagNotFoundException("Falta la tarifa (impuesto)");
					    }
						...
						try{
					    	...
					    	throw new TagNotFoundException("Falta la base imponible (impuesto)");
					    }
						...
						try{
					    	...
					    	throw new TagNotFoundException("Falta el valor (impuesto)");
					    }
					}
					DetImpuestos.add(impuesto);
				}
		...
		try{
			...
			NodeList campoAdicionalTags = infoAdicionalElements.getElementsByTagName("campoAdicional");
			for (int ca=0; ca<campoAdicionalTags.getLength(); ++ca) {
				ec.unomas.notacredito.InfoAdicional factura_infoAdicional = new ec.unomas.notacredito.InfoAdicional();
				Node campoAdicional = campoAdicionalTags.item(ca);
				NamedNodeMap campoAdicionalAttr = campoAdicional.getAttributes();
	...
	public GuiaRemision readGuiaRemision(Document doc) throws NullPointerException{
	    ...
	    try{
		    ...
		    Element contribuyenteEspecialElement = (Element) contribuyenteEspecialTag.item(0);
		    NodeList contribuyenteEspecial = contribuyenteEspecialElement.getChildNodes();
		    guiaRemision.setContribuyenteEspecial(Integer.parseInt(((Node) contribuyenteEspecial.item(0)).getNodeValue()));
	    }catch (NullPointerException e){
	    }
		...
		for (int d = 0; d < distanatarioTags.getLength(); d++) {
			...
			if (destinatario.getNodeType() == Node.ELEMENT_NODE) {
			    ...
			    try{
					...
					Vector<ec.unomas.guiaremision.DestinatariosDetalles> guiaremision_destDetalles = new Vector<ec.unomas.guiaremision.DestinatariosDetalles>();
					for (int i=0; i<detalleTag.getLength(); ++i) {
						ec.unomas.guiaremision.DestinatariosDetalles guiaremision_destDetalle = new ec.unomas.guiaremision.DestinatariosDetalles();
						...
						if (destinatario.getNodeType() == Node.ELEMENT_NODE) {
						    ...
						    try{
								...
								NodeList detAdicionalTag = detallesAdicionalesElements.getElementsByTagName("detAdicional");
								Vector<ec.unomas.guiaremision.DestinatariosDetallesAdicional> detAdicionales = new Vector<ec.unomas.guiaremision.DestinatariosDetallesAdicional>();
								for (int da=0; da<detAdicionalTag.getLength(); ++da) {
									ec.unomas.guiaremision.DestinatariosDetallesAdicional guiaremision_destDetAdicional = new ec.unomas.guiaremision.DestinatariosDetallesAdicional();
									Node detAdicional = detAdicionalTag.item(da);
									NamedNodeMap detAdicionalAttr = detAdicional.getAttributes();
		...
		try{
			...
			NodeList campoAdicionalTags = infoAdicionalElements.getElementsByTagName("campoAdicional");
			for (int ca=0; ca<campoAdicionalTags.getLength(); ++ca) {
				ec.unomas.guiaremision.InfoAdicional guiaremision_infoAdicional = new ec.unomas.guiaremision.InfoAdicional();
				Node campoAdicional = campoAdicionalTags.item(ca);
				NamedNodeMap campoAdicionalAttr = campoAdicional.getAttributes();
