 ...
 * @author USUARIO
 */
public class Modal_CrearFacturas2 extends javax.swing.JInternalFrame {
    ...
    Double iva = Double.valueOf(jc.iva);
...
//  
    ...
    private void datosPredeterminadosFacturas() {
        ...
        lbl_subTotalIva.setText("Sub Total IVA " + jc.iva + "%");
        ...
        switch (jc.documentoPredeterminadoFacturacion) {
            case "FACTURA":
        ...
        productosAutoCompleter = new TextAutoCompleter(txtBuscar2, new AutoCompleterCallback() {
            ...
            public void callback(Object selectedItem) {
                ...
                if (selectedItem instanceof Productos) {
                    ...
                    registros = facDao.Buscar_registros(c.getProducto(), jc.bodegaPredeterminadaenVenta.substring(0, 1));
                    registros[1] = String.valueOf(jTable1.getRowCount() + 1);
                    String stock = registros[9];
                    stockok = Double.parseDouble(stock);
                    if (jc.permitirvendersinstock.equals("SI")) {
                        ...
                        if (Double.parseDouble(stock) > 0) {
                            ...
                            JOptionPane.showMessageDialog(null, "NO TIENE STOCK BODEGA: " + jc.bodegaPredeterminadaenVenta);
//                            modelo.addRow(registros);
//                            jTable1.setModel(modelo);
                        }
                    }
...
////formas de pago
        ...
        jcbFormasPago.setSelectedItem(jc.formadepagopredeterminada);
...
//************************************
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            if (jTable1.getRowCount() != 0) {
                ...
                switch (jcbFormasPago.getSelectedItem().toString()) {
                    ...
                    verifica si esta activado el el control de efectivo y cambio
                        ...
                        u.setEfectivo(0.00);
                        u.setCambio(0.00);
                        if (jc.controlCambioEfectivoSINO.equalsIgnoreCase("SI")) {
                            if (!check_proformas.isSelected()) {
                ...
                if (procedeVentaExitosa) {
                    ...
                    if (cofigFacok == 0) {
                        ...
                        if (jc.facturatiriiasoGrande.equalsIgnoreCase("ROLLO")) {
                    ...
                    if (check_tikets.isSelected()) {
                        ...
                        System.out.println("Numero de veces: " + Integer.parseInt(jc.numerovecseimpresionFactura));
                        for (int i = 0; i < Integer.parseInt(jc.numerovecseimpresionFactura); i++) {
                            if (jc.tickettiriiasoGrande.equalsIgnoreCase("ROLLO")) {
                ...
                //                    for (int i = 0; i < Integer.parseInt(jc.numerovecseimpresionFactura); i++) {
                //
                //                        if (jc.proformatiriiasoFacturaGrande.equalsIgnoreCase("ROLLO")) {
                //                            impresionEnTirillas(u);
                //                        } else {
        ...
        if (procedeVentaExitosa) {
            ...
            jcbFormasPago.setSelectedItem(jc.formadepagopredeterminada);
            JOptionPane.showMessageDialog(null, "Forma de pago predeterminadaxc: " + jc.formadepagopredeterminada);
        }
        procedeVentaExitosa = false;
...
//actionEvent.getKeyCode() != 10
    ...
    private void calculosAlseleccionarProductodesdeJList(){
            ...
            if (!nombre.isEmpty()) {
                ...
                if (jc.permitirvendersinstock.equals("SI")) {
                    if (jc.ItemRepetidoEnFacturacionSumarCantidad.equalsIgnoreCase("SI")) {
