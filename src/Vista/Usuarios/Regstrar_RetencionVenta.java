 ...
 * @author USUARIO
 */
public class Regstrar_RetencionVenta extends javax.swing.JInternalFrame {
    ...
    ////
    public Regstrar_RetencionVenta() {
        initComponents();
                ...
                if (evt.getClickCount() == 2) {
                    if (jTable1.getSelectedRow() != -1) {
                        ...
                        if (jTable1.getRowCount() > 0) {
                            ...
                            int i = 0;
                            Double val = 0.0;
                            Regstrar_RetencionVenta.txtTotal.setText("0.0");
                            while (i <= Regstrar_RetencionVenta.modelo.getRowCount()) {
                                val = val + Double.parseDouble(Regstrar_RetencionVenta.modelo.getValueAt(i, 6).toString());
                                String totalret = String.valueOf(String.format("%.4f", val).replace(",", "."));
                                Regstrar_RetencionVenta.txtTotal.setText(totalret);
                                i++;
                            }
                        }
