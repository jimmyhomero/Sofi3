...
//import AA_MainPruebas.JtableconBotones;
...
import static Vista.Usuarios.Crear_Clientes.isllamadoDesdeRegistroMasivoCOmprasSRI;
import static Vista.Usuarios.Modal_Crear_compras.llenarCompraviaclaveAcceso;
 ...
 * @author USUARIO
 */
public class RegistraComprasMasivamaente extends javax.swing.JInternalFrame implements Runnable {
    ...
    public static boolean seregistrocorrectamenteProveedorDesdeRegistoComprasMasivasSRI = false;
    ...
    public RegistraComprasMasivamaente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("RegistraComprasMasivamente");
    ...
    private void llamarJfieldCooser() {
        ...
        Integer totalfilas = jTable1.getRowCount();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (!nombrearchivoseleccionado.isEmpty()) {
            ...
            Leertxt.descargarXMLformSRItoFileXMLandPFDenUnSoloPasoconHilo(ruta);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        Integer colRUCProveedor = 2;
        Integer colExisteProveedor = 10;
        if (evt.getClickCount() == 2) {

            Integer row = jTable1.getSelectedRow();
            Integer col = jTable1.getSelectedColumn();
            //   Deb.consola( "88888888: "+SetRenderJTableCXC.get_jtable_cell_component(jTable1, row, col).getBackground().toString());
            String claveAcceso = jTable1.getValueAt(row, colClaveAcceso).toString();
            if (jTable1.getValueAt(row, colExisteProveedor).toString().equalsIgnoreCase("NO")) {
                ...
                obj.isllamadoDesdeRegistroMasivoCOmprasSRI = true;
                obj.txt_cedulax.setText(jTable1.getValueAt(row, colRUCProveedor).toString());
                OperacionesForms.nuevaVentanaInternalForm(obj, obj.getTitle(), false);

                Deb.consola("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
            }
            if (jTable1.getValueAt(row, colExisteProveedor).toString().equalsIgnoreCase("SI")) {
                ///REGISTRA LA  COMPRA
                ...
                mcc.txtNumeroAutorizacion.setText(claveAcceso);
                mcc.llenarCompraviaclaveAccesoVerificaExistenciadexxxxxxxx();
