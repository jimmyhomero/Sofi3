 ...
 * Tfanticio change this template file, choose Tools | Templates
 ...
 * @author USUARIO
 */
public class Modal_registrarNCCompras extends javax.swing.JInternalFrame {
...
//  
    ...
    public Modal_registrarNCCompras() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addComponent(jPanel13, javax.swing.GroupLayout.DEFAULT_SIZE, 1055, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                ...
                if (procedeVentaExitosa) {
                    ...
                    if (cofigFacok == 0) {
                        ...
                        if (idFacturaSeleccionadaDesdeListadeFacturasParaNotaCredito != 0) {
                            ...
                            Double v2 = Double.parseDouble(ValorAfectadoNotaCreditoFacturaSeleccionadaDesdeListadeFacturasParaNotaCredito);
                            Double vt = v1 + v2;

                            p.setValorAfectadoxNCenFactura(String.valueOf(String.format("%.3f", vt)));
                            pdao.update(p);
                        }
...
//        listx.clearSelection();
    ...
    private void txtBuscar2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscar2KeyPressed
        ...
        if (evt.getKeyCode() != 10 && txtBuscar2.getText().length() >= 3) {
            ...
            Deb.consola(cadena);
            Deb.consola(txtBuscar2.getText());
            productosAutoCompleter.removeAllItems();
            ProductosDao pDao = new ProductosDao();
    ...
    private void jcbuscKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jcbuscKeyTyped
        // TODO add your handling code here:
        Deb.consola("Vista.Usuarios.Modal_CrearFacturas.jcbuscKeyTyped()ggggggggggggg");
    ...
    private void jcbuscKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jcbuscKeyReleased
        // TODO add your handling code here:
        Deb.consola("Vista.Usuarios.Modal_CrearFacturas.jcbuscKeyReleased()sssssssssssssss");
