 ...
 * @author USUARIO
 */
public class PrecioTotalComprasXFila extends javax.swing.JDialog {
    ...
    public PrecioTotalComprasXFila(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();        
...
//        jTable1.grabFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrecioTotalComprasXFila.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PrecioTotalComprasXFila dialog = new PrecioTotalComprasXFila(new javax.swing.JFrame(), true);
