 ...
 * @author USUARIO
 */
public class IngresoCaja extends javax.swing.JInternalFrame {
 ...
 ProgressBar msg = new ProgressBar(2000, "Mensaje Inicial");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 500, 510));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
       ...
       cjd.setDetalle(Variables.CAJA_INGRESO_MANUAL +" "+login.nombresUsuario+" DESDE EQUIPO: "+login.nombreDelEquipo);
       cjd.setTipo(Variables.CAJA_TIPO_INGRESO);
       cjd.setDocumento(Variables.CAJA_INGRESO_MANUAL);
