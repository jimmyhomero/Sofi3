...
import ecx.unomas.guiaremision.InfoAdicional;
import ecx.unomas.service.Config;

public class GuiaRemision {
	public void generatePDF(ecx.unomas.guiaremision.GuiaRemision guiaRemision, ServletOutputStream servletOutputStream) throws DocumentException, MalformedURLException, IOException{
		...
		if (!guiaRemision.getContribuyenteEspecial().isEmpty()){
	    ...
	    Vector<ecx.unomas.guiaremision.Destinatarios> destinatarios = guiaRemision.getDestinatarios();
	    for (int i=0; i< destinatarios.size(); i++){
		    ...
		    Vector<ecx.unomas.guiaremision.DestinatariosDetalles> destDetalles = destinatarios.get(i).getDetalle();
